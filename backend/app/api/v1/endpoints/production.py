...
@router.get("/lines")
async def get_production_lines(credentials: HTTPAuthorizationCredentials = Depends(security)):
...
async def get_production_line(line_id: str, credentials: HTTPAuthorizationCredentials = Depends(security)):
...
async def start_production_line(line_id: str, credentials: HTTPAuthorizationCredentials = Depends(security)):
...
async def stop_production_line(line_id: str, credentials: HTTPAuthorizationCredentials = Depends(security)):
...
async def get_energy_analytics(credentials: HTTPAuthorizationCredentials = Depends(security)):
...
async def get_fluoride_analytics(credentials: HTTPAuthorizationCredentials = Depends(security)):
